<template>
  <nav>
    <div class="py-3 px-4 border-b flex w-full justify-between">
      <div class="flex gap-4 items-center">
        <img src="" class="w-10 h-10 rounded-full ring-1 ring-black flex-shrink-0" alt="logo" />
        <h1 class="text-xl font-semibold">Ramdhan Nassyirah</h1>
      </div>
